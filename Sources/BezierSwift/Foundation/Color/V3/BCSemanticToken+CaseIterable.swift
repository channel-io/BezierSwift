...
extension BCSemanticToken: CaseIterable {
  /// 열거 가능한 semantic 색 토큰 전체. 선언 순서(Border → ChartTheme → Dim → Elevation → …)를 따른다.
  ///
  ...
  public static let allCases: [BCSemanticToken] = [
    ...
    .fillAbsoluteWhite, .fillAbsoluteWhiteLight, .fillAbsoluteWhiteTransparent, .fillAccentBlue,
    .fillAccentBlueHeavier, .fillAccentBlueHeavy, .fillAccentBlueTransparent, .fillAccentCobalt,
    ...
    .fillAccentOrangeTransparent, .fillAccentPink, .fillAccentPinkHeavier, .fillAccentPinkHeavy,
    .fillAccentPinkTransparent, .fillAccentPurple, .fillAccentPurpleHeavier,
    .fillAccentPurpleHeavy, .fillAccentPurpleTransparent, .fillAccentRed, .fillAccentRedHeavier,
    .fillAccentRedHeavy, .fillAccentRedTransparent, .fillAccentTeal, .fillAccentTealHeavier,
    .fillAccentTealHeavy, .fillAccentTealTransparent, .fillAccentYellow, .fillAccentYellowHeavier,
    .fillAccentYellowHeavy, .fillAccentYellowTransparent, .fillAction, .fillActionLight,
    .fillActionLighter, .fillActionTransparent, .fillBright, .fillCritical, .fillCriticalLight,
    .fillCriticalLighter, .fillCriticalTransparent, .fillGrey, .fillGreyHeavier, .fillGreyHeavy,
    ...
    .iconHighlight, .iconInverseHeavier, .iconNeutral, .iconNeutralHeavier, .iconNeutralHeavy,
    .iconSuccess, .iconWarning,
    .stateActive, .stateDefault, .stateFocus, .stateWarning,
    ...
    .textHighlight, .textInverse, .textNeutral, .textNeutralHeaviest, .textNeutralLight,
    .textNeutralLighter, .textSuccess, .textWarning,
  ]
}
