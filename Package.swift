...
let package = Package(
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/SDWebImage/SDWebImageWebPCoder", .upToNextMajor(from: "0.9.1"))
  ],
  targets: [
    ...
    .target(
      name: "BezierSwift",
      dependencies: ["SnapKit", "SDWebImage", "SDWebImageSwiftUI", "SDWebImageWebPCoder"],
      path: "BezierSwift",
      sources: ["Sources"],
