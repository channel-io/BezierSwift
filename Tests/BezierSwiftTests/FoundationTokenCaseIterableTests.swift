...
private extension BCSemanticToken {
  var shouldBeEnumerated: Bool {
    ...
    case .borderAbsoluteWhite, .borderDetach, .borderDetachHigh, .borderDetachHigher,
         ...
         .borderNeutralHeavy, .dimAbsoluteBlack, .dimAbsoluteBlackHeavy, .dimAbsoluteWhite,
         .dimAbsoluteWhiteHeavy, .elevationBase, .elevationBaseInner, .elevationLarge,
         .elevationMedium, .elevationSmall, .elevationXlarge, .fillAbsoluteBlack,
         .fillAbsoluteBlackLight, .fillAbsoluteBlackTransparent, .fillAbsoluteWhite,
         .fillAbsoluteWhiteLight, .fillAbsoluteWhiteTransparent, .fillAccentBlue,
         .fillAccentBlueHeavier, .fillAccentBlueHeavy, .fillAccentBlueTransparent,
         .fillAccentCobalt, .fillAccentCobaltHeavier, .fillAccentCobaltHeavy,
         .fillAccentCobaltTransparent, .fillAccentGreen, .fillAccentGreenHeavier,
         .fillAccentGreenHeavy, .fillAccentGreenTransparent, .fillAccentNavy,
         .fillAccentNavyHeavier, .fillAccentNavyHeavy, .fillAccentNavyTransparent,
         .fillAccentOlive, .fillAccentOliveHeavier, .fillAccentOliveHeavy,
         .fillAccentOliveTransparent, .fillAccentOrange, .fillAccentOrangeHeavier,
         .fillAccentOrangeHeavy, .fillAccentOrangeTransparent, .fillAccentPink,
         .fillAccentPinkHeavier, .fillAccentPinkHeavy, .fillAccentPinkTransparent,
         .fillAccentPurple, .fillAccentPurpleHeavier, .fillAccentPurpleHeavy,
         .fillAccentPurpleTransparent, .fillAccentRed, .fillAccentRedHeavier,
         .fillAccentRedHeavy, .fillAccentRedTransparent, .fillAccentTeal,
         .fillAccentTealHeavier, .fillAccentTealHeavy, .fillAccentTealTransparent,
         .fillAccentYellow, .fillAccentYellowHeavier, .fillAccentYellowHeavy,
         .fillAccentYellowTransparent, .fillAction, .fillActionLight, .fillActionLighter,
         .fillActionTransparent, .fillCritical, .fillCriticalLight, .fillCriticalLighter,
         .fillCriticalTransparent, .fillHighlight, .fillHighlightLight,
         .fillHighlightLighter, .fillHighlightTransparent, .fillNeutral, .fillNeutralHeavier,
         .fillNeutralHeaviest, .fillNeutralHeavy, .fillNeutralLight, .fillNeutralLighter,
         .fillNeutralLightest, .fillNeutralTransparent, .fillSuccess, .fillSuccessLight,
         .fillSuccessLighter, .fillSuccessTransparent, .fillWarning, .fillWarningLight,
         .fillWarningLighter, .fillWarningTransparent, .fillBright, .fillGrey,
         .fillGreyHeavier, .fillGreyHeavy, .fillGreyLight, .gradientAccentGreen,
         .gradientAccentGreenLight, .iconAbsoluteBlack, .iconAbsoluteWhite, .iconAccentBlue,
         ...
         .iconNeutral, .iconNeutralHeavier, .iconNeutralHeavy, .iconSuccess, .iconWarning,
         .iconInverseHeavier, .stateAction, .stateActionLight, .stateActive, .stateDefault,
         .stateWarning, .stateWarningLight, .surface, .surfaceGlass, .surfaceGlassHigh,
         .surfaceGlassHigher, .surfaceGlassHighest, .surfaceHigh, .surfaceHigher,
         .surfaceHighest, .surfaceLow, .textAbsoluteBlack, .textAbsoluteWhite,
         .textAccentBlue, .textAccentCobalt, .textAccentGreen, .textAccentNavy,
         .textAccentOlive, .textAccentOrange, .textAccentPink, .textAccentPurple,
         .textAccentRed, .textAccentTeal, .textAccentYellow, .textAction, .textCritical,
         .textHighlight, .textNeutral, .textNeutralHeaviest, .textNeutralLight,
         .textNeutralLighter, .textSuccess, .textWarning, .textInverse, .chartThemeDefault01,
         .chartThemeDefault02, .chartThemeDefault03, .chartThemeDefault04,
         .chartThemeDefault05, .chartThemeDefault06, .chartThemeDefault07,
         .chartThemeDefault08, .chartThemeDefault09, .chartThemeDefault10:
      return true
...
struct BCSemanticTokenCaseIterableTests {
  @Test("열거 대상 174개를 담고 custom은 제외한다")
  func containsEveryEnumerableCase() {
    #expect(BCSemanticToken.allCases.count == 174)
