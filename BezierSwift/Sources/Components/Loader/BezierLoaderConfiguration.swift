...
/// - Parameters:
///   - size: Spinner는 small, medium 2개의 사이즈를 가질 수 있습니다.
///     - medium: 화면 전체를 로딩할 때, 독립적인 요소로 쓰일 때 사용합니다.
///     - small: 다른 요소와 나란히 쓰일 때 사용합니다.
///   - variant: Spinner는 primary, seondary (default), on overlay 3개의 Variant 옵션을 가질 수 있습니다.
///     - primary: 화면 내에서 중요도가 높은 경우에만 사용합니다.
///     - seondary(default): 보편적인 경우에 사용합니다.
///     - onOverlay: dimmed layer 등과 함께할 때 사용합니다.
/// - Attention: 한 화면에 여러개의 Spinner를 표시하지 않습니다. 이는 유저의 행동을 방해할 수 있으며, 유저에게 필요 이상의 불안정한 상태를 제공합니다.
